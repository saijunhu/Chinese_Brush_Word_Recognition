...
class Radical(object):
    dictionary_filepath = r'C:\Users\saiju\PycharmProjects\Chinese_Brush_Word_Recognition\resources\radicals.csv'
    ...
    def post_baidu(self, url):
        ...
        try:
            ...
            response = urllib3.urlopen(request, timeout=timeout)
            html = response.read()
